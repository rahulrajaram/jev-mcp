...
This server rejects an oversized state before any request goes out, naming the token
estimate, and the API rejects a genuine overflow with `max_tokens_exceeded`.
